...
BEGIN
  ...
  FOR referral_item IN SELECT * FROM get_referral_chain(deposit_record.user_id) LOOP
    ...
    BEGIN
      -- Note: Using amount instead of net_amount (including coupon bonus) for referral commission calculation 
      -- to prevent overpaying commissions on "bonus" funds.
      ...
      IF commission_amt > 0 THEN
        ...
        INSERT INTO transactions (
          ...
          referral_item.referrer_id,
          'referral_commission'::transaction_type, -- Correct cast
          commission_amt,
          commission_amt,
          'completed',
